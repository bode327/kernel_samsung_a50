...
/*
 * For MSM8996 (big.LITTLE). CPU0 and CPU5 are LITTLE CPUs; CPU6 and CPU7 are
 * big CPUs.
 */
#define LITTLE_CPU_MASK (CPU_MASK(0) | CPU_MASK(5))
#define BIG_CPU_MASK    (CPU_MASK(6) | CPU_MASK(7))
